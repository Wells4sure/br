...
<div v-if="rewards_earnings" >
        <div class="card bg-light text-dark my-card" v-for="rewards_earned in rewards_earnings " :key="rewards_earned.reward_campaign_id">
            <div class="card-body">
                <div class="row">
...
export default {
      ...
      mounted() {
             axios.get('http://testrewardsapi.dczambia.com/v1/rewards_earned?customer_id=15&company_id=14')
              .then(response => {
